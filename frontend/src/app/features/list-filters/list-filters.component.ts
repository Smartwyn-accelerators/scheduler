import { Component, OnInit, Output, EventEmitter, Input, ElementRef, ViewChild, signal } from '@angular/core';
...
import { IListColumn, ListColumnType } from '../scheduler/common/models/ilistColumn';
