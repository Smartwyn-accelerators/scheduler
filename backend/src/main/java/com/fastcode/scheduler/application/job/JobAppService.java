...
import com.fastcode.scheduler.domain.irepository.IJobRepository;
...
import com.fastcode.scheduler.domain.model.QJobEntity;
import com.fastcode.scheduler.domain.model.QJobHistoryEntity;
import com.fastcode.scheduler.CGenClassLoader;
...
public class JobAppService implements IJobAppService {
	...
	public List<String> listAllJobClasses() throws URISyntaxException {
		...
		String packageName = env.getFastCodeJobsDefault();
		if(packageName == null) {
